...
// Copy all font files to the dist folder
gulp.task('fonts', function() {
    gulp.src(config.paths.fonts)
        .pipe(gulp.dest(config.dist.dir + '/' + config.fonts.dir))
});

// Copy all image files to the dist folder
gulp.task('images', function() {
    gulp.src(config.paths.img)
        .pipe(gulp.dest(config.dist.dir + '/' + config.images.dir))
})
...
gulp.task('all', ['html', 'css', 'js', 'fonts', 'images'], function() {
    gulp.start('serve');
    gulp.start('watch');
});
